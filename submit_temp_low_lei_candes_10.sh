...
#SBATCH --job-name=bart_temp_low_lei_candes_10
#SBATCH --partition=low
#SBATCH --array=1-100
#SBATCH --output=slurm_logs/temp_runs/low_lei_candes_10/%A_%a.out
#SBATCH --error=slurm_logs/temp_runs/low_lei_candes_10/%A_%a.err
...
LOG_DIR="slurm_logs/temp_runs/low_lei_candes_10"
