...
#SBATCH --job-name=bart_init_piecewise_linear_20
#SBATCH --partition=low
#SBATCH --array=1-100
#SBATCH --output=slurm_logs/init_runs/piecewise_linear_20/%A_%a.out
#SBATCH --error=slurm_logs/init_runs/piecewise_linear_20/%A_%a.err
...
LOG_DIR="slurm_logs/init_runs/piecewise_linear_20"
