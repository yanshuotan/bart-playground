...
class Tree:
    ...
    def _print_node(self, node_id):
        ...
        if self.vars[node_id] == -1:
            ...
            return f"X_{self.vars[node_id]} <= {self.thresholds[node_id]:0.3f}" + f" (split, n = {n_output})"
...
class Parameters:
    ...
    def evaluate(
        ...
        tree_ids: Optional[List] = None,
        all_except: Optional[List] = None,
    ) -> NDArray[np.float_]:
        """
