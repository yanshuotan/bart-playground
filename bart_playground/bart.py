...
class BART:
    ...
    def __init__(self, preprocessor: Preprocessor, sampler: Sampler,
                 ndpost=1000, nskip=100, marginalize: bool = False):
        """
        ...
        Parameters:
            ...
            ndpost: Number of posterior samples.
            nskip: Number of burn-in iterations.
            marginalize: If True, the MH ratio calculations will marginalize over the entire ensemble.
        """
    ...
    def update_fit(self, X, y, add_ndpost=20, add_nskip=10, quietly=False):
        ...
        # Update thresholds if needed (TODO)
        self.sampler.add_thresholds(self.preprocessor.thresholds)
