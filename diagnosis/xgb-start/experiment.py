...
from bart_playground import DefaultBART, MultiBART
...
from bart_playground.xgb_init import fit_and_init_trees
...
def _build_xgb_init_trees(
    ...
    *,
    ...
    xgb_fit_kwargs: dict | None = None,
    debug: bool = False,
):
    preprocessor = DefaultBART.preprocessor_class(max_bins=100)
    ...
    fit_kwargs = dict(xgb_fit_kwargs or {})

    _, init_trees = fit_and_init_trees(
        data.X,
        data.y,
        dataX=data.X,
        params=params,
...
def run_chain(
    *,
    ...
    xgb_params: dict | None = None,
    xgb_fit_kwargs: dict | None = None,
    xgb_debug: bool = False,
):
    """Run default and mtmh on the same split."""
    ...
    init_trees = None
    if xgb_init:
        init_trees = _build_xgb_init_trees(
            X_train,
            y_train,
            n_trees=n_trees,
            random_state=chain_seed,
            xgb_params=xgb_params,
            xgb_fit_kwargs=xgb_fit_kwargs,
            debug=xgb_debug,
        )
    ...
    *,
    ...
    run_result = {
        ...
        "metadata": {
            ...
            "xgb_init": bool(xgb_init),
            "xgb_params": xgb_params or {},
            "xgb_fit_kwargs": xgb_fit_kwargs or {},
            "xgb_debug": bool(xgb_debug),
        },
    }
...
def run_parallel_experiments(
    ...
    """Run experiments grouped by run and chain for DefaultBART and MultiBART.
