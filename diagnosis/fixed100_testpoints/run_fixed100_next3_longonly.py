...
DATASET_CONFIGS: dict[str, dict[str, Any]] = {
    # Existing datasets kept for compatibility.
    "abalone": {
    ...
    "parkinsons": {
        ...
        "long_ndpost": 1_000_000,
        "long_store_every": 100,
        # subject# is an ID, not a predictive covariate.
        "drop_columns": ["subject#"],
        "categorical_columns": [],
        # If this column is in ucimlrepo targets, use it; otherwise pop it from features.
    ...
    "seoul_bike": {
        ...
        "long_ndpost": 1_000_000,
        "long_store_every": 100,
        # Date is a string timestamp. Rented Bike Count is the regression target.
        "drop_columns": ["Date"],
        # Auto one-hot for Seasons, Holiday, Functioning Day, etc.
...
def main():
    parser = argparse.ArgumentParser(description="Fixed-100 default_long-only benchmark for selected regression datasets.")
    parser.add_argument("--datasets", nargs="+", choices=sorted(DATASET_CONFIGS), default=["ccpp", "parkinsons", "seoul_bike"])
