...
#SBATCH --job-name=bart_init_high_lei_candes_100
#SBATCH --partition=low
#SBATCH --array=1-100
#SBATCH --output=slurm_logs/init_runs/high_lei_candes_100/%A_%a.out
#SBATCH --error=slurm_logs/init_runs/high_lei_candes_100/%A_%a.err
...
LOG_DIR="slurm_logs/init_runs/high_lei_candes_100"
