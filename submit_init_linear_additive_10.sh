...
#SBATCH --job-name=bart_init_linear_additive_10
#SBATCH --partition=low
#SBATCH --array=1-100
#SBATCH --output=slurm_logs/init_runs/linear_additive_10/%A_%a.out
#SBATCH --error=slurm_logs/init_runs/linear_additive_10/%A_%a.err
...
LOG_DIR="slurm_logs/init_runs/linear_additive_10"
